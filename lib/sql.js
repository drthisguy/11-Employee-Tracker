...
joinRolesToDepts(dept) {
    ...
    (err, res) => {
        ...
        console.log(`\nThe payroll budget for ${colors.fg.blue}${department}${colors.sp.reset} is: ${colors.fg.green}${budget}${colors.sp.reset}`);
    }
  )
}
...
joinEmploysToRoles(role) {
    ...
    (err, res) => {
        ...
        console.log(`\nThe payroll budget for ${colors.fg.blue}${title}s${colors.sp.reset} is: ${colors.fg.green}${budget}${colors.sp.reset}`);
    }
  )
}
}