...
deptOpts()   {
    return inquirer.prompt(
        ...
        choices: ["View all departments",  "Update a department",  "Add a new department", "Remove a department", "Look up all employess by department",  "Calculate department bugets", "Return home"]
        }
    )
}
