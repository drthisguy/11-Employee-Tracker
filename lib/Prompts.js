...
deptOpts()   {
    return inquirer.prompt(
        ...
        choices: ["View all departments", "Add a new department", "Change a department\'s name",  "Remove a department", "Look up all employess by department",  "View department, payroll budgets", "Return home"]
        }
    )
}
