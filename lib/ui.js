...
roleOpts()   {
    return inquirer.prompt(
        ...
        prefix: '*',
        message: `JOb Titles:   \n${line}\n`,
        choices: ["View all job titles", "Create a new position", "Change a role\'s title",  "Remove an existing role", "Look up all employess by title",  "Calculate payroll budgets by job title", "Return home", `${line}`]
        }
    )
}
